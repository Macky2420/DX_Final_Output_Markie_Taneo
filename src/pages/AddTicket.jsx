...
const AddTicket = () => {
  ...
  const { loading, error, data } = useQuery(DISPLAY_TICKET, {
    variables: { user_id },
  });

  if (loading) return (<div className="fixed -translate-x-2/4 -translate-y-2/4 z-[9999] left-2/4 top-2/4">
                        <Loading />
                      </div>);
